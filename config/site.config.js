...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'software@softwarehub.cloud',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/Games/1,000 + PC GAMES LIST',
  ...
  links: [
    {
      name: 'Facebook',
      link: 'https://www.facebook.com/itechph101/',
    },
  ],
